...
/*GPIO常用的5种模式*/
#define GPIO_MODE_OUTPUT_PP 		0X3     //推挽输出
#define GPIO_MODE_OUTPUT_FF 		0XB     //复用推挽
#define GPIO_MODE_INPUT_UP  		0X9     //上拉输入
#define GPIO_MODE_INPUT_DOWN		0X8     //下拉输入
#define GPIO_MODE_INPUT_ANALOG    0X0	    //模拟输入
